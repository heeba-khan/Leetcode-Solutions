...
//         if(root1->left&&root2->left==NULL) root1->left->val+=0;
//         if(root1->left==NULL&&root2->left) {
//             TreeNode* lnode=new TreeNode(root2->left->val);
//             root1->left=lnode;
//         }
//         if(root1->right&&root2->right==NULL) root1->right->val+=0;
...
//         if(root1&&!root2) root1->val+=0;
//         if(!root1&&root2){
//             TreeNode* m=new TreeNode(root2->val);
//             root1=m;
//         }
